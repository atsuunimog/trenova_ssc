						...
						<div class="contact-form-area m-top-30 text-center">
							...
							<form class="form" method="post" action="login">
								<div class="row">
									...
									<input type="hidden" name="log-user">

									<div class="col-12">
										<div class="form-group button">
											<span class='d-block my-3'>New to School Support Centre? <a href='sign-up' class='font-weight-bold'>Create an account</a>
											 or <a href='forgot-password' class='font-weight-bold'>forgot password</a></span>
