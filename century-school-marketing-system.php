							...
							<div class="col-12">
								<div class="blog-single-main">
                                    ...
                                    <h4 class='font-weight-bold'>
                                        At TreNova School Support Centre we focus on helping private schools build a Marketing and 
                                        Sales Machine that delivers pre- qualified leads through the new age marketing system and strategies. 
                                        When you list on the Nova marketing platform, the system will automatically help you to implement the 
                                        following out-of-the-box marketing strategies to improve your enrolment:
                                    </h4>
                                    <ul>
                                        <li>School Online Video Tour</li>
                                        <li>Effective bait marketing system</il>
                                        <li>Proof-it-marketing system</li>
                                        <li>Targeted referral marketing system</li>
                                        <li>Digital marketing</li>
                                        <li>Profile listing and key word search</li>
                                        <li>Market place access</li>
                                        <li>Website Optimization and Ranking Factor Improvement</li>
                                        <li> Google My Business Leads Score Improvement</li>
                                        <li>Review Rating Improvement</li>
                                        <li>Website Accessibility and Performance Improvement</li>
                                    </ul>
									</div>
								</div>
							</div>
