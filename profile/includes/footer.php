			...
			<div class="footer-top">
				<div class="container">
					<div class="row">
								...
								<div class="logo">
									<div class="img-logo">
										<a class="logo" href="index.html">
											<h3 class="widget-title">Trenova</h3>
											<!-- <img class="img-responsive" width="50" height="50" src="img/trenova_img/trenova_tran_icon.png" alt="logo"> -->
										</a>
									</div>
								</div>
						...
						<!-- Footer Links -->		
							<div class="single-widget f-link widget">
								<h3 class="widget-title">Membership Package</h3>
								<ul>
									<li><a href="pricing.php">Basic</a></li>
									<li><a href="pricing.php">Essential</a></li>
									<li><a href="pricing.php">Standard</a></li>
								</ul>
							</div>			
							<!--/ End Footer Links -->	
						</div>
						<div class="col-lg-4 col-md-6 col-12">	
							...
							<div class="single-widget footer_contact widget">	
								...
								<ul class="address-widget-list">
									<li class="footer-mobile-number"><i class="fa fa-phone"></i>+(234) 809-0178-721</li>
									<li class="footer-mobile-number"><i class="fa fa-envelope"></i>info@trenovaacademy.com</li>
									<li class="footer-mobile-number"><i class="fa fa-map-marker"></i>7B Ogunsiji Close, Allen, Ikeja, Lagos</li>
								</ul>
							</div>		
							<!--/ End Footer Contact -->						
						</div>
					...
					<div class="row">
						<div class="col-12">
							<div class="copyright-content">
								<!-- Copyright Text -->
								<p>© Copyright <a href="#" style='color:#6fb71d;'>SchoolSupportCentre</a> <?php echo date("Y"); ?>. Design &amp; Development By <a target="_blank" href="#" style='color:#6fb71d;'>Trenova Academy</a></p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="wa_click_to_chat">
			...
			<a href="https://wa.me/2348090178721?text=<?php echo urlencode("Hello! Trenova"); ?>" target="_blank">
			<img src="../img/pixel/whats_app.png" class="img-fluid" alt="chat_icon">
			</a>
			</div>
		</div>
		<!--whats app click to chat-->
